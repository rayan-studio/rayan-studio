...
Je suis etudiant en `BTS SIO` option `SLAM`, avec un parcours oriente vers le developpement full-stack et les outils logiciels.
...
- Langues: `Francais` natif, `Anglais` niveau `B1 / B2`
...
- `Direction de l'Innovation et des Systemes d'Information - Nimes`
  Developpement d'un outil `CLI` en `C#` pour l'envoi de SMS et creation d'un site web de consultation de logs `TrueNAS`.
- `Inersio - Sorgues`
  Travail sur le style d'un site administratif avec `JavaScript`.
- `Geoitech Trust - Maroc`
  Decouverte et utilisation de `WordPress`.
